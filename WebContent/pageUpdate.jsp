...
<body>
	...
	<h2 align="center" style="margin-top:2rem;">Update Profile Info here</h2>
	...
	<form action="Update" method="post">
		...
		<input type="text" name="fullname" id ="name" value ="${fullname}"></input> <br>
		<label for="birth">Change Date of Birth:</label>
		<input type="date" name="birth" id ="birth" value ="${birth}"></input> <br>
